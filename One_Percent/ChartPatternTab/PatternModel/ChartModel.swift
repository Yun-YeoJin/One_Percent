...
struct ChartInfo {
    ...
    static let chartPattern: [PatternsModel] = [
        ...
        PatternsModel(title: "상승형 삼각형 패턴", description: "상승형 삼각형 패턴이 나타나고 나서는 계속 상승살 가능성이 높다.", imageName: "Ascending Triangle"),
        ...
        PatternsModel(title: "하락형 가리비 패턴", description: "내림차순 가리비 패턴의 모양은 J 의 거울 이미지와 유사합니다. 패턴의 시작 부분에서 가격 수준의 급격한 하락이 있습니다. 최저점에 도달한 후 점차 회복되어 바닥에 둥근 계곡을 형성합니다. 왼쪽 봉우리가 오른쪽 봉우리보다 높아서 패턴의 모양을 정당화합니다", imageName: "Descending scallop")
